...
const en = {
  ...
  home: {
    ...
    roundKicker: 'Next round',
    roundPrompt: 'Ready for the next round?',
    roundPrompt_kids: 'The arena is waiting.',
    roundSub: 'Set your stance, clear the frame and begin.',
    prepTitle: 'Before the bell',
    setupHint: 'Prop your phone on a tripod about 2 m away',
    setupFrame: 'Step into the camera frame',
    streakDaysOne: 'day streak',
    streakDaysOther: 'day streak',
    quests: 'Quests',
    cornerTitle: 'Your corner',
    modesTitle: 'Modes',
    viewProgress: 'Open training log',
    startTraining: 'Start round',
  ...
  profiles: {
    ...
    chooseCorner: 'Choose your corner',
    readyForNextRound: 'Ready for the next round, {{name}}',
  ...
  progress: {
    ...
    streak: 'Streak',
    logged: 'Logged in the ring',
    roundsRecord: 'Completed rounds',
    punchesThrown: 'Punches landed',
    ...
    emptyBody: 'Train a round to start your record.',
  },
