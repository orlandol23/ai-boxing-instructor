...
const ptBR = {
  ...
  home: {
    ...
    roundKicker: 'Próximo round',
    roundPrompt: 'Pronto para o próximo round?',
    roundPrompt_kids: 'A arena está esperando.',
    roundSub: 'Ajuste sua base, fique no enquadramento e comece.',
    prepTitle: 'Antes do sino',
    setupHint: 'Posicione o celular num tripé a ~2m de distância',
    setupFrame: 'Entre no enquadramento da câmera',
    streakDaysOne: 'dia seguido',
    streakDaysOther: 'dias seguidos',
    quests: 'Missões',
    cornerTitle: 'Seu canto',
    modesTitle: 'Modos',
    viewProgress: 'Abrir diário de treino',
    startTraining: 'Começar round',
  ...
  profiles: {
    ...
    chooseCorner: 'Escolha o seu canto',
    readyForNextRound: 'Pronto para o próximo round, {{name}}',
    continueTraining: 'Continuar treinando',
  ...
  progress: {
    ...
    total: 'Total',
    trainingLog: 'Diário de treino',
    summary: 'Resumo do treino',
    recentRounds: 'Rounds recentes',
    ...
    totalPunches: 'Golpes',
    streak: 'Sequência',
    logged: 'Registrado no ringue',
    roundsRecord: 'Rounds concluídos',
    punchesThrown: 'Golpes aplicados',
    roundRecord: 'Registro do round',
    completed: 'Concluído',
    passed: 'Aprovado',
    belowThreshold: 'Abaixo do limite',
    notAttempted: 'Não tentado',
    emptyTitle: 'Ainda sem histórico',
    emptyBody: 'Treine um round para começar o registro.',
  },
